 ...
 */
int hasProcess( TaskPriority *tasks, int task_size, int flag_time )
{
    int i, exist;
 ...
 */
TaskPriority* priority( int flag_time, TaskPriority *tasks, int task_size )
{
    int i, j, k, pr, idx;
 ...
 */
void CPU( TaskPriority *tasks, int task_size, TaskPriority *running_task, 
 ...
 */
int isPreempt( TaskPriority *tasks, int task_size, int curr_time, TaskPriority *running_task )
{
    int i, j, ii;
    int *undone_idx, idx;
    int preempt = FALSE;
 ...
 */
int next_preempt( TaskPriority *tasks, int task_size, 
                  TaskPriority *running_task, int *preempt_idx )
{
    int i, j;
    int time;
...
int sum_burst( TaskPriority *tasks, int task_size )
{
    int i;
    int sum = 0;
    for ( i = 0; i < task_size; ++i )
